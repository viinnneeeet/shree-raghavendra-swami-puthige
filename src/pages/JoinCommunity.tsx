...
const JoinCommunity = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({
      ...
      interests: [], experience: '', availability: '', message: ''
    });
  };
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Become part of our spiritual family and contribute to the temple's mission of spreading divine grace and community service.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              <Card className="border-temple-gold/20 shadow-sacred mb-8">
                <CardHeader>
                  <CardTitle className="text-2xl text-temple-earth">Our Temple History</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-6">
                    Shree Raghavendra Swami Temple has been a beacon of spiritual light for nearly four decades, 
                    serving devotees and the community with unwavering dedication to spiritual growth and social service.
                  </p>
                  
                  <div className="space-y-4">
                    {templeHistory.map((item, index) => (
                      <div key={index} className="flex items-start space-x-4">
                        <Badge variant="outline" className="border-temple-gold text-temple-gold min-w-fit">
                          {item.year}
                        </Badge>
                        <div>
                          <h4 className="font-semibold text-temple-earth">{item.event}</h4>
              ...
              <Card className="border-temple-gold/20 shadow-sacred">
                <CardHeader>
                  <CardTitle className="text-2xl text-temple-earth">Our Mission</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    To create a sacred space where individuals can connect with the divine, 
                    learn ancient wisdom, and serve the community with love and compassion.
                  </p>
            ...
            <Card className="border-temple-gold/20 shadow-sacred">
              <CardHeader>
                <CardTitle className="text-2xl text-temple-earth">Community Membership Form</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.availability} onValueChange={(value) => setFormData({ ...formData, availability: value })}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="festivals">Festivals & Special Events</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="message">Why do you want to join our community?</Label>
                    <Textarea
                      id="message"
          ...
          {/* Community Benefits */}
          <div>
            <h2 className="text-3xl font-bold text-center mb-8 text-temple-earth">Community Benefits</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {communityBenefits.map((benefit, index) => (
                <Card key={index} className="border-temple-gold/20 shadow-sacred text-center">
                  <CardContent className="pt-6">
                    <benefit.icon className="w-12 h-12 mx-auto mb-4 text-temple-gold" />
                    <h3 className="font-semibold text-temple-earth mb-2">{benefit.title}</h3>
          ...
          <Card className="mt-12 border-temple-gold/20 shadow-sacred">
            <CardHeader>
              <CardTitle className="text-2xl text-temple-earth text-center">Contact Us</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">123 Divine Path, Sacred Hills</p>
                </div>
                <div className="flex flex-col items-center space-y-2">
                  <Clock className="w-8 h-8 text-temple-gold" />
                  <h4 className="font-semibold text-temple-earth">Office Hours</h4>
                ...
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">1000+ Active Members</p>
                </div>
              </div>
            </CardContent>
          </Card>
