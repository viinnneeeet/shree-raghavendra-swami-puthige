...
const VisitUs = () => {
  ...
  const facilities = [
    { icon: Car, title: 'Free Parking', description: 'Ample parking space available for devotees' },
    { icon: Users, title: 'Rest Areas', description: 'Comfortable seating areas for elderly and families' },
    { icon: MapPin, title: 'Prasada Counter', description: 'Sacred food offerings available daily' }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Come experience divine peace and spiritual serenity at Shree Raghavendra Swami Temple.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="border-temple-gold/20 shadow-sacred">
              ...
              <CardContent className="space-y-6">
                <div>
                  <h3 className="font-semibold text-temple-earth mb-2">Temple Address</h3>
                  <p className="text-muted-foreground">
                    123 Divine Path, Sacred Hills<br />
                    Spiritual Valley, State 560001<br />
                    India
                  </p>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-muted-foreground">info@raghavendra-temple.org</span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {timings.map((timing, index) => (
                    <div key={index} className="flex justify-between items-center py-2 border-b border-temple-gold/10 last:border-b-0">
                      <span className="font-medium text-temple-earth">{timing.day}</span>
                      <span className="text-muted-foreground text-sm">{timing.time}</span>
                    </div>
                  ))}
                </div>
                <div className="mt-4 p-3 bg-temple-gold/10 rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    <strong>Note:</strong> Aarti timings: 7:00 AM, 12:00 PM, and 7:00 PM daily
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="border-temple-gold/20 shadow-sacred mb-12">
            <CardHeader>
              <CardTitle className="text-2xl text-temple-earth">Location Map</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {/* Facilities */}
          <div>
            <h2 className="text-3xl font-bold text-center mb-8 text-temple-earth">Temple Facilities</h2>
              ...
              {facilities.map((facility, index) => (
                <Card key={index} className="border-temple-gold/20 shadow-sacred hover:shadow-temple transition-shadow">
                  <CardContent className="text-center pt-6">
                    ...
                    <h3 className="font-semibold text-temple-earth mb-2">{facility.title}</h3>
