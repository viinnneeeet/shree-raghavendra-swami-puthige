...
const GalleryPage = () => {
  ...
  const categories = ['All', 'Spiritual', 'Festivals', 'Service', 'Temple', 'Education'];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Explore the beauty and spirituality of our temple through these sacred moments and celebrations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredImages.map((image, index) => (
              <Card key={index} className="group border-temple-gold/20 shadow-sacred hover:shadow-temple transition-all duration-300 overflow-hidden">
                <div className="relative overflow-hidden">
                  ...
                  <Badge 
                    variant="outline" 
                    className={`absolute top-3 right-3 border ${getCategoryColor(image.category)}`}
                  >
                    {image.category}
                  </Badge>
                </div>
                <CardContent className="pt-4">
                  <h3 className="font-semibold text-temple-earth mb-2">{image.title}</h3>
          ...
          <Card className="mt-12 border-temple-gold/20 shadow-sacred">
            <CardContent className="pt-6">
              <div className="grid md:grid-cols-4 gap-6 text-center">
                <div>
                  <h3 className="text-3xl font-bold text-temple-gold mb-2">500+</h3>
                  <p className="text-muted-foreground">Photos Captured</p>
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-temple-purple mb-2">50+</h3>
                  <p className="text-muted-foreground">Events Documented</p>
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-temple-sunset mb-2">25+</h3>
                  <p className="text-muted-foreground">Festivals Celebrated</p>
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-temple-earth mb-2">1000+</h3>
